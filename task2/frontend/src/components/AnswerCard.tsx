...
import { Sparkles, ShieldCheck, ChevronDown, ChevronUp, Zap, FileText, ExternalLink, CheckCircle, AlertTriangle } from 'lucide-react';
      ...
      <div className="editorial-card p-6 sm:p-8 relative">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b-2 border-[#1E5A3B]/30 pb-4 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {latency && (
              <span className={`px-3 py-1 rounded-full text-xs font-editorial-mono font-bold border flex items-center gap-1.5 ${
        ...
        {/* Answer Text Block */}
        <div className="p-6 rounded-2xl bg-[#0A4C2B] text-[#F7F1DF] border-2 border-[#FFD400] shadow-[4px_4px_0px_#FFD400] mb-6">
